...
export default function About() {
  return (
    <React.Fragment>
    <h1>About Us</h1>
    <p><b>Shoppe</b> is the online medical store, we all need. It offers medicines at affordable price and at remote locations.
    ...
    we tend to make the medical world easier and accessible by customizing the medicine availability in all remote locations irrespective of any city or region barrier.
    We have various services available here including medicine classifications, disease based segregation, smooth processing of payment through cash or card, easy
    ...
    <footer>&copy; 2022 <b>SHOPPE</b></footer>
    </React.Fragment>
  )
}
